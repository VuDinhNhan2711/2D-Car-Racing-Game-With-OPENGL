...
void fristDesign() {
    ...
    if (gv == 1) {
        ...
        glColor3f(1.000, 0.000, 0.000);
        char buffer2[50];
        sprintf(buffer2, "Diem Cua Ban La : %d", score);
        renderBitmapString(33, 60 - 4 + 10, (void*)font1, buffer2);

    }

    glColor3f(1.000, 1.000, 0.000);
    renderBitmapString(15, 80, (void*)font1, "2D Car Racing Game With OPENGL");

    glColor3f(0.000, 1.000, 0.000);
    renderBitmapString(30, 50 + 10, (void*)font2, "Nhan SPACE de START");
    renderBitmapString(30, 50 - 3 + 10, (void*)font2, "Nhan ESC de Exit");
    ...
    renderBitmapString(40 - 5, 50 - 40, (void*)font3, "NHOM 2:");
    renderBitmapString(30 - 5, 50 - 43, (void*)font3, "XIN CHAO MOI NGUOI DEN VOI CUOC DUA");
